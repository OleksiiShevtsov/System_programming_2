...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_user_5finfo_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_user_5finfo_2eproto = nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_5finfo_2eproto = {
  false, false, 64, descriptor_table_protodef_user_5finfo_2eproto, "user_info.proto", 
  &descriptor_table_user_5finfo_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_user_5finfo_2eproto::offsets,
  file_level_metadata_user_5finfo_2eproto, file_level_enum_descriptors_user_5finfo_2eproto, file_level_service_descriptors_user_5finfo_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_user_5finfo_2eproto_getter() {
  return &descriptor_table_user_5finfo_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_user_5finfo_2eproto(&descriptor_table_user_5finfo_2eproto);
